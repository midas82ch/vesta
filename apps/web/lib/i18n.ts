...
const de = {
  ...
  "availability.confirmed": "Direkt erreichbar",
  "availability.call_to_confirm": "Bitte vorher Kontakt aufnehmen",
  "availability.unknown": "Bitte direkt nachfragen",
  "results.uncertainty": "Einzelne Angaben müssen abgeklärt werden.",
  "results.originalLanguage": "Diese Informationen sind derzeit nur auf Deutsch verfügbar.",
  "results.checked": "Automatisch geprüft am {date}",
  "results.source": "Zum Angebot",
  "results.distance.meters": "ca. {distance} m entfernt",
  "results.distance.kilometers": "ca. {distance} km entfernt",
  ...
  "dialogue.result.eyebrow": "Passende Angebote",
  "dialogue.result.title": "Passende Angebote für dich",
...
const fr: Record<MessageKey, string> = {
  ...
  "availability.confirmed": "Accessible directement",
  "availability.call_to_confirm": "Prends contact avant de te déplacer",
  "availability.unknown": "Renseigne-toi directement",
  "results.uncertainty": "Certaines informations doivent être vérifiées.",
  "results.originalLanguage":
    "Ces informations sont actuellement disponibles uniquement en allemand.",
  "results.checked": "Vérification automatique le {date}",
  "results.source": "Voir l’offre",
  "results.distance.meters": "à environ {distance} m",
  "results.distance.kilometers": "à environ {distance} km",
  "results.address": "Adresse",
  ...
  "dialogue.result.eyebrow": "Offres adaptées",
  "dialogue.result.title": "Des offres adaptées pour toi",
...
const en: Record<MessageKey, string> = {
  ...
  "availability.confirmed": "Available directly",
  "availability.call_to_confirm": "Please contact them before you go",
  "availability.unknown": "Please ask them directly",
  ...
  "results.source": "Open service",
  "results.distance.meters": "about {distance} m away",
  "results.distance.kilometers": "about {distance} km away",
  ...
  "dialogue.result.eyebrow": "Suitable services",
  "dialogue.result.title": "Suitable services for you",
