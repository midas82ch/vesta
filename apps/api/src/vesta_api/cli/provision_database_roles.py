...
ROLES = (
    DatabaseRole(
        ...
        table_privileges={
            ...
            "question_need_definitions": ("SELECT",),
            "offer_localizations": ("SELECT",),
            "admin_users": ("SELECT",),
    ...
    DatabaseRole(
        ...
        table_privileges={
            ...
            "offer_import_settings": ("SELECT",),
            "offer_localizations": ("SELECT", "INSERT", "UPDATE"),
        },
    ),
    DatabaseRole(
        ...
        table_privileges={
            ...
            "offer_localizations": ("SELECT", "INSERT", "UPDATE"),
            "offer_import_jobs": ("SELECT", "INSERT", "UPDATE"),
        },
    ),
    DatabaseRole(
        username="vesta_worker",
        secret_filename="database-worker-url",
        table_privileges={
            "organizations": ("SELECT", "INSERT"),
            "offers": ("SELECT", "INSERT"),
            "offer_categories": ("SELECT", "INSERT"),
            "offer_verifications": ("SELECT", "INSERT"),
            "offer_localizations": ("SELECT", "INSERT"),
            "offer_import_jobs": ("SELECT", "UPDATE"),
            "need_definitions": ("SELECT",),
            "admin_users": ("SELECT",),
            "admin_change_log": ("INSERT",),
            "ai_interaction_log": ("INSERT",),
        },
    ),
)
